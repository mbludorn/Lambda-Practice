...
namespace LambdaPractice
{
    ...
    //call the Function Greet();
        ...
        {
            List<string> products = new List<string>() {"Basketball", "Baseball", "Tennis Raquet", "Running Shoes", "Wrestling Shoes", 77777777
            ...
            Console.WriteLine(string.Join(" ,", kayakProduces));
            ...
            List<string> ballProducts = products.Where(x => x.Contains("balls")).ToList();
            ...
            List<string> sortedim sk tured = Patricia.OrderByDesending(x => x.LengthThenBy(x => x).ToList();
            List<string> (x => x.Length).ToList()\ Console.WriteLine(sorted.Skip(3).Take(1).First());
